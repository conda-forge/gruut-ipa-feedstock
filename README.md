...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gruut-ipa-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14114&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gruut-ipa-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gruut-ipa` can be installed with:

```
conda install gruut-ipa
```

It is possible to list all of the versions of `gruut-ipa` available on your platform with:
